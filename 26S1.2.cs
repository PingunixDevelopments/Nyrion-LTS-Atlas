...
namespace NyrionShell
{
    class Program
    {
        ...
        static readonly string ATLAS_VERSION = "Atlas";
        static readonly string BUILD = "26S1.2";
        static readonly string PREFIX = "QopWarren Build 6020 - Prefix QWE";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(ATLAS_VERSION);
        ...
        static void MainLoop()
        {
            while (true)
            {
                try
                {
                    ...
                    Console.Write("Atlas:" + Directory.GetCurrentDirectory() + "> ");
                    Console.ResetColor();
            ...
            try
            {
                switch (command)
                {
                    ...
                    case "uptime":
                        ...
                        break;
                    case "exit":
                        Console.WriteLine("Exiting Atlas shell...");
                        Environment.Exit(0);
                        break;
                    default:
        ...
        static void QweShowHelp()
        {
            ...
            Console.WriteLine(" qwe nyrver        - Show Atlas version");
        ...
        {
            Console.WriteLine("Nyrion Version = " + ATLAS_VERSION);
        ...
        {
            Console.WriteLine("Atlas Has Crashed!");
